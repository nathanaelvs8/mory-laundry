            ...
            <div className="table-container">
                <div className="table-header">
                    ...
                    <div className="search-box">
                        <FaSearch /><input type="text" placeholder="Cari user..." value={search} onChange={(e) => setSearch(e.target.value)} />
                    </div>
                </div>
                <table>
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr key={u.id}>
                                ...
                                <td>
                                    {u.role !== 'admin' && <button className="action-btn delete" onClick={() => handleDelete(u.id, u.role)}><FaTrash /></button>}
                                </td>
                            </tr>
                        ))}
                    </tbody>
