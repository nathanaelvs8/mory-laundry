        ...
        <DashboardLayout title="Laporan Transaksi">
            ...
            <div className="stats-grid print-area" style={{ marginBottom: 20 }}>
                <div className="stat-card">
                    <img src="/images/icon-total-transaksi.svg" alt="" style={{ width: 40, height: 40 }} />
                    <div>
                ...
                <div className="stat-card">
                    <img src="/images/icon-transaksi-selesai.svg" alt="" style={{ width: 40, height: 40 }} />
                    <div>
                ...
                <div className="stat-card">
                    <img src="/images/icon-total-pendapatan.svg" alt="" style={{ width: 40, height: 40 }} />
                    <div>
                ...
                <div className="stat-card">
                    <img src="/images/icon-rata-rata.svg" alt="" style={{ width: 40, height: 40 }} />
                    <div>
