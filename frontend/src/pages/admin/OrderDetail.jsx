            ...
            <div className="table-container print-area" style={{padding: 30}}>
                ...
                <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20, marginBottom: 30}}>
                    <div style={{background: '#f9f9f9', padding: 20, borderRadius: 10}}>
                        ...
                        {order.address && <p style={{margin: '8px 0', fontSize: 14}}><strong>Alamat:</strong> {order.address}</p>}
                    </div>
                    <div style={{background: '#f9f9f9', padding: 20, borderRadius: 10}}>
                        ...
                        {order.notes && <p style={{margin: '8px 0', fontSize: 14}}><strong>Catatan:</strong> {order.notes}</p>}
                    </div>
                </div>
